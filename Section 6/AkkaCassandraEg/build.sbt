...
//libraryDependencies +="com.datastax.cassandra" % "cassandra-driver-mapping" % "1.0.1"
//libraryDependencies +="com.datastax.cassandra" % "cassandra-driver-extras" % "1.0.1"
